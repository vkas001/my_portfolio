    ...
    public function run(): void
    {
        $profile = Profile::query()->updateOrCreate(
            ...
            [
                ...
                'short_bio' => 'I build fast, delightful web experiences — from pixel-perfect UIs to resilient APIs. I ship complete products end-to-end and I\'m open to senior full-stack or platform roles.',
                ...
                'personal_note' => 'Remote · Kathmandu. Outside work I tinker with OS-style web interfaces, real-time systems and AI-assisted workflows, and I\'m currently exploring Android TV and lean-back experiences.',
                'strengths' => [
                ...
                'strengths_icon' => 'star',
                'personal_note_title' => 'A bit about me',
                'personal_note_icon' => 'sparkles',
                'avatar_url' => null,
                'resume_url' => null,
